...
import {
  ...
  UpdatePool,
  Withdraw
} from "../generated/masterChefVTX/masterChefVTX"
...
export function handleAdd(event: Add): void {
  ...
  //
  // - contract.PoolManagers(...)
  // - contract.addressToPoolInfo(...)
  // - contract.createRewarder(...)
  // - contract.depositInfo(...)
  // - contract.getPoolInfo(...)
  // - contract.owner(...)
  // - contract.pendingTokens(...)
  // - contract.poolLength(...)
  // - contract.registeredToken(...)
