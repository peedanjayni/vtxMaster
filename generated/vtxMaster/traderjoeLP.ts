...
export class traderjoeLP__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class traderjoeLP__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class traderjoeLP extends ethereum.SmartContract {
  static bind(address: Address): traderjoeLP {
    return new traderjoeLP("traderjoeLP", address);
  }
  ...
  burn(to: Address): traderjoeLP__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new traderjoeLP__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<traderjoeLP__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new traderjoeLP__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): traderjoeLP__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new traderjoeLP__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<traderjoeLP__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new traderjoeLP__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
