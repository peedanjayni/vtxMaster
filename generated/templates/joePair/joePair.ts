...
export class joePair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class joePair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class joePair extends ethereum.SmartContract {
  static bind(address: Address): joePair {
    return new joePair("joePair", address);
  }
  ...
  burn(to: Address): joePair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new joePair__burnResult(result[0].toBigInt(), result[1].toBigInt());
  }

  try_burn(to: Address): ethereum.CallResult<joePair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new joePair__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): joePair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new joePair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<joePair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new joePair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
